...
var l = '8';
// 請文字解釋為什麼
console.log(k * l > 21);      // k是num type, l是string type, l會因為自動轉型為num type, so (k * l = 24) > 21.
...
calorieBurn += (activities.bicycle.caloriePerMinute * 10);
calorieBurn += (activities.treadmill.caloriePerMinute * 30);
calorieBurn += (activities.yoga.caloriePerMinute * 40);
calorieBurn += (activities.bicycle.caloriePerMinute * 10);
