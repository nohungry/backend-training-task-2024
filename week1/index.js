...
AlexBudget = AlexBudget - (3 * yogaGroupClass) - (3 * weightTrainingGroupClass);
...
// 宣告 numberArr1 陣列，內容為 [5, 10, 15]
// 將 numberArr1 的值指派給 numberArr2        (指向同一個記憶體位置)
// 在 numberArr2 陣列中新增 20                (numberArr1 和 numberArr2 都會新增 20)
// 將 numberArr2 陣列重新指派為 [25, 30, 35]  (numberArr2 指向新的記憶體位置, numberArr1 不受影響)
